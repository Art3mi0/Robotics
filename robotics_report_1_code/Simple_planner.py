...
if __name__ == '__main__':
	...
	plan_point3.linear.y = 0.267
	plan_point3.linear.z = 0.3
	plan_point3.angular.x = 3.07
	plan_point3.angular.y = -0.07
	plan_point3.angular.z = -1.566
	# add this point to the plan
	...
	plan_point4.linear.y = 0.267
	plan_point4.linear.z = 0.056
	plan_point4.angular.x = 3.07
	plan_point4.angular.y = -0.07
